...
function Home({setLoggedin }) {
  ...
  return (<div className = "home" style = {{minHeight : "100vh", display : "flex", alignItems:"center", flexDirection : "column"}}>
  ...
  <div className = "nav-bar">
    ...
    <div className = "nav-search-bar">
        <input style = {{backgroundColor : "transparent"}} className = "search-bar"></input>
    ...
    <div className = "nav-upload-db" >
      ...
      <input type ="file" className = "add-folder-input"style = {{marginTop : "-5px", width:"70%", backgroundColor : "transparent", color : "beige"}} onChange={(e)=>{
        setFile(e.target.files[0]);
      }}></input>
      {/* <button style = {{width:"30%", height : "25px", marginTop : "-7px", marginBottom:"6px"}}>Upload</button> */}
      ...
      <button style = {{backgroundColor : "rgba(0,0,0,0.4)"}} onClick = {async (e)=>{
        ...
        try {
          ...
          alert('folder img upload failed')
        }
      }}>Add</button>
    </div>
    </div>
  ...
  <div style={{ color: "white" }}>hello.</div></div>);
}
export default Home;